...
type Route struct {
	...
	RepeatWaitResolve bool            `yaml:"repeat_wait_resolve,omitempty" json:"repeat_wait_resolve,omitempty"`
}
...
type Receiver struct {
	...
	NsqLakersConfig  []*NsqLakersConfig `yaml:"nsq_lakers_configs,omitempty" json:"nsq_lakers_configs,omitempty"`
